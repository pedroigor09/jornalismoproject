...
Enquanto o telejornalismo baiano se abre para a diversidade da fala, repórteres e apresentadores se veem cada vez mais autorizados a serem eles mesmos. Silvana Freire é um exemplo marcante desse movimento. Com mais de duas décadas de trajetória, ela afirma sem hesitar: "Ser baiana é falar do nosso jeito, é resistir, é ter coragem de ocupar o espaço sem deixar o axé da gente pra trás." Silvana viveu, na própria carreira, a transição entre o modelo de televisão que neutralizava sotaques e o modelo atual, que celebra a autenticidade. Ao lembrar sua experiência como correspondente na CNN Brasil, ela conta que era recebida no ar com entusiasmo: para o público, sua presença simbolizava que "a Bahia chegou".
